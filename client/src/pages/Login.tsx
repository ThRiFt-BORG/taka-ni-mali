...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{backgroundColor: '#0e691eff'}}>
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-input rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500"
            ...
            <Button
              type="submit"
              className="w-full bg-white border-primary text-primary hover:bg-green-50"
              disabled={loginMutation.isPending}
            >
          ...
          <div className="mt-4">
            <Link href="/">
              <Button variant="outline" className="w-full bg-white border-primary text-primary hover:bg-green-50">
                Back to Home
              </Button>
            </Link>
          </div>
