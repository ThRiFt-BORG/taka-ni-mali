...
export default function Home() {
  ...
  return (
    <div className="min-h-screen p-4 md:p8" style={{backgroundColor: '#006400'}}>
      {/* Navigation Header */}
          ...
          <div className="flex items-center gap-4">
            {isAuthenticated ? (
              <>
                ...
                <Button variant="outline" size="sm" onClick={logout} className="bg-white border-primary text-primary hover:bg-green-50">
                  Logout
                </Button>
              </>
            ) : (
              <>
                <Link href="/login">
                  <Button variant="outline" size="sm" className="bg-white border-primary text-primary hover:bg-green-50">
                    Login
                  </Button>
                </Link>
                <Link href="/register">
                  <Button variant="outline" size="sm" className="bg-white border-primary text-primary hover:bg-green-50">Sign Up</Button>
                </Link>
              </>
            )}
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <Card className="bg-amber-300 hover:shadow-lg transition-shadow">
            <CardHeader>
        ...
        {/* CTA Section */}
        <div className="bg-amber-300 rounded-lg shadow-lg p-8 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border border-input rounded-lg p-6">
              ...
              <Link href="/dashboard">
                <Button variant = "outline" className="w-full bg-white border primary text-primary hover:bg-green-50">Open Dashboard</Button>
              </Link>
            </div>
            ...
            <div className="border border-input rounded-lg p-6">
              ...
              {isAuthenticated && (user?.role === "collector" || user?.role === "admin") ? (
                <Link href="/collector">
                  <Button variant = "outline" className="w-full bg-white border primary text-primary hover:bg-green-50">Submit Collection</Button>
                </Link>
              ) : (
                <Link href="/login">
                  <Button variant = "outline" className="w-full bg-white border primary text-primary hover:bg-green-50">Login as Collector</Button>
                </Link>
              )}
            </div>
          </div>
        ...
        {/* Info Section */}
        <div className="bg-amber-300 rounded-lg shadow-lg p-8">
      ...
      {/* Footer */}
      <footer className="bg-amber-300 rounded-lg border-t border-input mt-16">
        <div className="max-w-7xl mx-auto py-8 text-center text-lg text-muted-foreground">
